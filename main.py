...
def run_program():
    app.destroy()
    subprocess.call(["python", "C:/Users/sagar/OneDrive/Desktop/Two-way-sign-language-communicator/Sign to text/Application.py"])
 

classifier = load_model('C:/Users/sagar/OneDrive/Desktop/Two-way-sign-language-communicator/model.h5')
def give_char():
       import numpy as np
...
op_dest="C:/Users/sagar/OneDrive/Desktop/Two-way-sign-language-communicator/filtered_data/"
alpha_dest="C:/Users/sagar/OneDrive/Desktop/Two-way-sign-language-communicator/alphabet/"
...
class StartPage(tk.Frame):
       ...
       def __init__(self, parent, controller):
              ...
              button.pack()
              button2 = tk.Button(self, text="Sign to Text",command=run_program)
              button2.pack()
              load = PIL.Image.open("C:/Users/sagar/OneDrive/Desktop/Two-way-sign-language-communicator/Two Way Sign Language Translator.png")
...
class VtoS(tk.Frame):
       def __init__(self, parent, controller):
              ...
              def hear_voice():
                     ...
                     text_output = r.recognize_google(audio) #to print voice into text
